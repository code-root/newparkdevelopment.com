                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('pages.store')); ?>" method="POST" enctype="multipart/form-data" id="create-form">
                                    <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function () {
        ...
        $('#generate-slug').click(function () {
            const name = $('#name').val();
            if (name) {
                $.post("<?php echo e(route('pages.check-slug')); ?>", {
                    name: name
                }, function (data) {
                    $('#slug').val(data.slug);
                    $('#slug-error').hide();
...
<?php echo $__env->make('dashboard.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macstoreegypt/Documents/Projects/sadaadd.com/resources/views/dashboard/pages/create.blade.php ENDPATH**/ ?>